...
namespace winrt::BiliUWP::implementation {
    struct AppCfgModel : AppCfgModelT<AppCfgModel> {
        ...
        bool App_UseWinUI3Style();
        void App_UseWinUI3Style(bool value);
        ...
        bool App_OverrideSpaceForPlaybackControl();
        void App_OverrideSpaceForPlaybackControl(bool value);
        ...
        bool App_EnableRealtimePlayback();
        void App_EnableRealtimePlayback(bool value);
        bool App_RedactLogs();
