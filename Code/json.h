...
namespace json {
    ...
    public:
        ...
        JsonArray(winrt::Windows::Data::Json::JsonArray const& ja);
    ...
    public:
        ...
        JsonObject(winrt::Windows::Data::Json::JsonObject const& jo);
        ...
        // TODO: Fix not compiling in C++20
    ...
    public:
        ...
        JsonValue(winrt::Windows::Data::Json::JsonValue const& jv);
        ...
        // C++/Winrt interop APIs
        bool try_deserialize_from_hstring(winrt::hstring const& str);
        // TODO: Add inter-convertion APIs?
    ...
    inline JsonObject::reverse_iterator JsonObject::rbegin() noexcept { return m_map.rbegin(); }
    inline JsonObject::const_reverse_iterator JsonObject::rbegin() const noexcept { return m_map.rbegin(); }
    inline JsonObject::const_reverse_iterator JsonObject::crbegin() const noexcept { return m_map.crbegin(); }
    inline JsonObject::reverse_iterator JsonObject::rend() noexcept { return m_map.rend(); }
    inline JsonObject::const_reverse_iterator JsonObject::rend() const noexcept { return m_map.rend(); }
    inline JsonObject::const_reverse_iterator JsonObject::crend() const noexcept { return m_map.crend(); }
}
