...
#include "FavouriteUserViewPage_ViewItem.g.h"
#include "FavouriteUserViewPage_ViewItemSource.g.h"

#include "AdaptiveGridView.h"
#include "BiliClient.hpp"

namespace winrt::BiliUWP::implementation {
    struct FavouriteUserViewPage_ViewItem : FavouriteUserViewPage_ViewItemT<FavouriteUserViewPage_ViewItem> {
        FavouriteUserViewPage_ViewItem(::BiliUWP::UserFavFoldersList_Folder const& data) : m_data(data) {}
    ...
    struct FavouriteUserViewPage_ViewItemSource : FavouriteUserViewPage_ViewItemSourceT<FavouriteUserViewPage_ViewItemSource> {
        FavouriteUserViewPage_ViewItemSource(uint64_t user_mid);
    ...
    struct FavouritesUserPage : FavouritesUserPageT<FavouritesUserPage> {
        ...
        BiliUWP::FavouriteUserViewPage_ViewItemSource ViewItemSource() { return m_view_item_src; }
